...
<View style={styles.card}>
  ...
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, weekly: parseFloat(text) || 0 })}
  ...
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, weight: parseFloat(text) || 0 })}
      keyboardType="decimal-pad"
      placeholder="Nhập cân nặng (ví dụ: 1500.5)"
      placeholderTextColor="#999"
    />
  </View>
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, height: parseFloat(text) || 0 })}
      keyboardType="decimal-pad"
  ...
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, bpm: parseFloat(text) || 0 })}
      keyboardType="decimal-pad"
  ...
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, movement: parseFloat(text) || 0 })}
      keyboardType="decimal-pad"
  ...
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, gsd: parseFloat(text) || 0 })}
      keyboardType="decimal-pad"
  ...
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, crl: parseFloat(text) || 0 })}
      keyboardType="decimal-pad"
  ...
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, bpd: parseFloat(text) || 0 })}
      keyboardType="decimal-pad"
  ...
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, fl: parseFloat(text) || 0 })}
      keyboardType="decimal-pad"
  ...
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, hc: parseFloat(text) || 0 })}
      keyboardType="decimal-pad"
  ...
  <View style={styles.inputGroup}>
    ...
    <TextInput
      ...
      onChangeText={(text) => setDetailRequest({ ...detailRequest, ac: parseFloat(text) || 0 })}
      keyboardType="decimal-pad"
